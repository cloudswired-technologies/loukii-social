...
import { 
  User, Phone, Mail, Globe, Upload, ChevronRight, ChevronLeft,
  Facebook, Instagram, Linkedin, Twitter, MapPin, Briefcase,
  FileText, Image as ImageIcon, Save, CheckCircle
} from "lucide-react";
    ...
    <div className="flex flex-col h-screen bg-white dark:bg-gray-950 overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-5">
